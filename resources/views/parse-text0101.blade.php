    ...
    <div
        ...
        <div class="p-4 w-max bg-whtie rounded-lg">
            <div class="  flex items-center justify-start" id="backButton">
                ...
                class="text-white uppercase bg-blue-600 rounded-full aspect p-2 flex items-center gap-2"><i
            ...
            <div class="relative w-[345px] sm:w-[500px]">
                <div class="w-full mx-auto">
                    {{-- upload --}}
                    <div id="fileUpload">
                        <form enctype="multipart/form-data" action="{{ route('post.0101') }}"
                            class="dropzone border-4 border-dotted border-blue-600  rounded-lg flex flex-col bg-gray-300 dark:bg-gray-100"
                            id="formUpload">
                            @csrf
                    ...
                    <div class="-bottom-14 w-full left-0">
                        <form action="{{ route('downloadFile0101') }}" method="POST" id="downloadFile" class="hidden">
                            @csrf
                            <input type="hidden" name="fileName" id="fileName" value="">
                            <button class="bg-blue-300 uppercase w-full rounded-xl p-2 text-black" id="downloadButton"

...
@section('content')
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex items-center justify-start mt-5" id="backButton">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    ...
                    <a href="{{ route('parse-0200') }}"
                        ...
                        <div>
                            <div class="flex justify-center">
                                <i
                                    class="lni lni-empty-file bg-green-800 bg-blend-overlay rounded-full aspect-square p-3 items-center justify-center flex text-white text-3xl"></i>
                            </div>
                    ...
                    <a href="{{ route('parse-0101') }}"
                        ...
                        <div>
                            <div class="flex justify-center">
                                <i
                                    class="lni lni-empty-file bg-blue-800 bg-blend-overlay rounded-full aspect-square p-3 items-center justify-center flex text-white text-3xl"></i>
                            </div>
                    ...
                    <a href="{{ route('parse-lainnya') }}"
                        ...
                        <div>
                            <div class="flex justify-center">
                                <i
                                    class="lni lni-empty-file bg-orange-800 bg-blend-overlay rounded-full aspect-square p-3 items-center justify-center flex text-white text-3xl"></i>
                            </div>

    ...
    <div
        ...
        <div class="p-4  w-max bg-whtie rounded-lg">
            <div class="  flex items-center justify-start" id="backButton">
                <a href="{{ route('menu-text') }}" class="text-white uppercase bg-green-600 rounded-full aspect p-2 flex "><i
                        class="lni lni-arrow-left"></i></a>
            </div>
            
            <div class="flex justify-center items-center flex-wrap text-wrap py-5">
                <p class="text-center font-semibold text-3xl my-3 dark:text-gray-100 text-gray-900">Parser 0200</p>
            </div>
            ...
            <div class="relative" style="width: 450px">
                <div class="w-full mx-auto">
                    {{-- upload --}}
                    <div id="fileUpload">
                        <form enctype="multipart/form-data" action="{{ route('post.0200') }}"
                            class="dropzone border-4 border-dotted border-green-600  rounded-lg flex flex-col bg-gray-300 dark:bg-gray-100"
                            id="formUpload">
                            @csrf

                            <div class="absolute -bottom-14 w-full left-0">
                                <button id="submitForm" type="submit"
                                    class="bg-green-500 w-full rounded-xl p-2 text-white"> <i
                        ...
                        <div class="table table-striped w-full" class="files" id="previews">
                            <div id="template"
                                class="file-row justify-between flex my-1 border p-1 bg-green-200 dark:bg-green-100 rounded-lg">
                    ...
                    <div class="-bottom-14 w-full left-0">
                        <form action="{{ route('downloadFile0200') }}" method="POST" id="downloadFile" class="hidden">
                            @csrf
                            <input type="hidden" name="fileName" id="fileName" value="">
                            <button class="bg-green-300 uppercase w-full rounded-xl p-2 text-black" id="downloadButton"
